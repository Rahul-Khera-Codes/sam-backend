...
- [ ] Market Agent — not started, needs a news-API vendor decision first (Currents/TheNewsAPI/Mediastack/GNews, $25-90/mo, shared cost with Competitor Agent's deferred news section).
- [ ] Report Scheduler — not started, depends on Lead Researcher + Competitor Agent + Market Agent all existing.
