...
**Phase B — remaining:** slice 3 = `email_detail` (read-only card from read_email). Reuses card infra; no new card_action. **Test:** "list my emails" / "what's on my calendar today" → card renders, Remi summarises briefly.
